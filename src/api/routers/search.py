...
def search_properties(
    ...
    location_id: str | None = Query(None, description="Filter by location UUID (exact node)"),
    location: str | None = Query(None, description="Location slug — matches this node and its whole subtree (city/locality/neighborhood)"),
